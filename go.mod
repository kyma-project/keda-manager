...
replace (
	// keda v2.20.0 pins the entire k8s.io/* suite and controller-runtime to specific versions;
	// those replaces don't propagate, so mirror them here.
	...
	k8s.io/client-go v1.5.2 => k8s.io/client-go v0.35.5

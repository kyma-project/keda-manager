...
replace (
	...
	k8s.io/client-go v1.5.2 => k8s.io/client-go v0.35.4

	// keda v2.19.0 uses ctrl.NewWebhookManagedBy with the v0.22 single-argument API; v0.23 changed
	// the signature to a two-argument generic form. Pin to the version keda itself pins to.

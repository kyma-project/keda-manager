...
| `operator.name`                                            | Name of the KEDA operator | `keda-manager` |
...
| `serviceAccount.name`                                      | The name of the service account to use. If not set and create is true, a name is generated.      | `keda-manager` |

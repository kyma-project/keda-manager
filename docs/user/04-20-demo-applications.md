...
## NATS JetStream Scaler Example

To learn how to autoscale a Deployment using JetStream consumer lag with the Keda module, see [NATS JetStream Scaler Example](https://github.com/kyma-project/keda-manager/tree/main/examples/nats-jetstream-scaler).

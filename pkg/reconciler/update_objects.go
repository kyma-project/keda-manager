...
func buildSfnUpdateAdmissionWebhooksLogging(u *unstructured.Unstructured) stateFn {
	...
	return buildSfnUpdateObject(u, updateKedaMetricsServerContainer0Args, loggingWebhookCfg, next)
}
...
func loggingWebhookCfg(k *v1alpha1.Keda) *v1alpha1.LoggingCommonCfg {
	if k != nil && k.Spec.Logging != nil {
		return k.Spec.Logging.Webhook
	}
	return nil
}

...
- **KEDA** (all caps) — the autoscaler project/tool at keda.sh. Example: "KEDA's Elasticsearch scaler", "KEDA polls CLS".
- **Keda module** (sentence case) — the Kyma module wrapper. Example: "the Keda module is enabled", "enable the Keda module".
